...
@interface AlertsViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
{
    ...
    NSMutableArray* tweetTime;
    IBOutlet UITableView *myTableView;
    //BOOL clearTable;
    //int hitLimit;
    

    NSMutableArray *tweetz;
    NSMutableData * receivedData;
}
@property (nonatomic, retain) NSMutableData * receivedData;

@property (nonatomic, retain) NSMutableArray* twitterText;
@property (nonatomic, retain) NSMutableArray* tweetTime;
@property (nonatomic, retain) NSMutableArray* tweetz;
///@property BOOL clearTable;
